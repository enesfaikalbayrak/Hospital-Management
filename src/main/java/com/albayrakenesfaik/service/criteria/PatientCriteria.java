...
/**
 * Criteria class for the {@link com.albayrakenesfaik.domain.Patient} entity. This class is used
 * in {@link com.albayrakenesfaik.web.rest.PatientResource} to receive all the possible filtering options from
...
public class PatientCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, fullName, email, identityNumber, telephoneNumber, gender, password, bloodType, appoitmentId, distinct);
    }
